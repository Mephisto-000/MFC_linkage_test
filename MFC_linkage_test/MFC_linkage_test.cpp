...
// MFC_linkage_test.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CMFClinkagetestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMFClinkagetestApp 建構

CMFClinkagetestApp::CMFClinkagetestApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CMFClinkagetestApp 物件

CMFClinkagetestApp theApp;


// CMFClinkagetestApp 初始化

BOOL CMFClinkagetestApp::InitInstance()
{
